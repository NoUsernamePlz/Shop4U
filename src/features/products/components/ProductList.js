...
import { fetchAllProductsAsync,fetchAllProductsByFilterAsync, fetchBrandsAsync, fetchCategoriesAsync, selectAllProducts, selectBrands, selectCategories, selectCount, selectTotalItems } from "../productSlice";
            ...
            <div>
              ...
              >
                ...
                {Array.from({length:totalpages}).map(
                  ...
                  aria-current="page"
                  className={`cursor-pointer relative z-10 inline-flex items-center ${index+1===page?'bg-indigo-600 text-white':'text-gray-800 bg-white'}  px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
                >
                  {index+1}
                </div>
            ...
            <div className="group relative border-solid border-2 p-3 border-gray-200">
              ...
              <div className="mt-4 flex justify-between">
                <div>
                  ...
                  <span className="mt-1 text-sm text-gray-500 align-bottom">
                    {product.rating}
                  </span>
                </div>
                <div>
